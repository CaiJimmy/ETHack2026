      ...
      <section className="explorer" aria-label="Data explorer">
        ...
        {view==='chart'&&<div className="finding-banner">
          <div className="finding-main">
            ...
            <p><strong>Promises vs Measured Pace:</strong> 108 companies report both historical reduction trajectories and 2030 targets. Companies above the dashed line are cutting emissions slower than promised (or increasing them), exposing a concrete target shortfall.</p>
          </div>
          <div className="finding-metrics">
            <div className="finding-stat"><span>Audited With Targets</span><strong>108 <small>companies</small></strong></div>
            <div className="finding-stat alert"><span>Lagging Promised Pace</span><strong>57% <small>positive gap</small></strong></div>
            <div className="finding-stat"><span>Average Gap</span><strong>+2.4 <small>pp / year</small></strong></div>
          </div>
        </div>}
